...
<body>
  ...
  <h1 class="eror">Page is being created...Hehe🙏</h1>
  <div class="w3-top">
    <div class="w3-bar w3-orange w3-wide w3-padding w3-card">
      <a href="" class="w3-bar-item w3-button w3-orange">Sorry this page EROR</a>
      <a href="" class="w3-bar-item w3-button w3-current w3-right">LogOut</a>    
    </div> 
  </div>
</body>
</html>
