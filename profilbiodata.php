...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="contact">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Daftar Profile</h3>
    ...
    ?>
        <tr>
          ...
          <td><a href="javascript:void(0)" class="w3-button w3-tiny " onClick="lihatid('<?php echo $row['foto'];?>')">Lihat Foto</button></td>
        </tr>
    ...
    <div class="w3-bar w3-border">
      ...
      for ($i=1; $i<=$total_pages; $i++) {   
        if ($i == $pageno) {   
            ...
            $pagLink .= "<a class='w3-bar-item w3-button w3-white' href='profilbiodata.php?pageno=".$i."'>".$i." </a>";     
        }   
      };     
      echo $pagLink; 
      if($pageno < $total_pages){  ?>
        <a class='w3-bar-item w3-button w3-white' href='<?php echo "profilbiodata.php?pageno=".($pageno+1);?>'>&raquo;</a>  
        <?php } else {    
        ?>
...
<footer class="w3-bottom w3-center w3-#FFECD1 w3-padding-5">
  <p>Powered by <a href="https://www.instagram.com/daeng_ngarru/#" title="W3.CSS" target="_blank" class="w3-hover-text-blue">Amat</a></p>
</footer>
